...
public class TestConfig{
	...
	public static String from = "prof.amit.arora@gmail.com";
	public static String password = "Shiva@0010";
	public static String[] to ={"amitarora0010@gmail.com","prof.amit.arora@gmail.com"};
